...
(function ($, window, undefined) {
    ...
    Socials = {
        fb: {
            ...
            url: "https://vk.com/share.php?act=count&url=", callback: function () {
            ...
            url: "http://api.pinterest.com/v1/urls/count.json?url=", callback: function (data) {
                if (data && data.count) {
                    this.count = data.count
                } else {
                    this.count = 0
    ...
    SocialButtons = {
        init: function (options, el) {
            ...
            if (oSocial) {
                ...
                if (oSocial.url) {
                    $.getScript(oSocial.url + self.shareUrl + "&callback=jQuery.fn.socialButtons." + network + "SetCount", function () {
